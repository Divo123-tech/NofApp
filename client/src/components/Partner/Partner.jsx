  ...
  return (
    <div className="min-h-screen bg-[#d2f8bd] flex flex-col items-center justify-start px-6 py-8">
      ...
      <div className="w-full text-left ml-10 mb-8">
        <h1 className="text-3xl md:text-3xl font-bold text-[#2183d2] mb-3">Marcus Tng</h1>
        <button class="bg-red-600 text-white font-semibold py-2 px-4 rounded-full">Remove accountability partner</button> 
      </div>
